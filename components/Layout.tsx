  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="	https://www.open24.com.co/" key="url" />
        <meta property="og:title" content="Open24 - Café, Snacks, Bebidas" key="title" />
        <meta property="og:description" content="Somos tiendas automáticas abiertas todos los días 24 horas" key="description" />
        <meta property="og:image" content="https://www.open24.com.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.f8adc8c8.png&w=384&q=75" key="logo" />
      </Head>
