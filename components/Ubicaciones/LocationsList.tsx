...
export default function LocationsList() {
  const locations = [
    {
      name: "Petrobras Centro Comercial El Manantial",
      address: "Peaje Patios vía La Calera",
